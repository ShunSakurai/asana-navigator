...
const localizationStrings = {
  ...
  en: {
    ...
    'confirmMessage-deleteInformation': 'All information contained in the task (due date, custom fields, description, other projects, tags, comments, etc.) will be deleted.',
    'confirmMessage-multipleTasks': 'Multiple tasks are selected. Only the first one will be converted.',
    'confirmMessage-taskIdChanged': 'The task ID will be changed, so any links pointing to this task will become invalid.',
    'confirmMessage-taskInProject': 'The task will be deleted from My Tasks or from the parent task.',
    'confirmMessage-taskNotInProject': 'The task will be deleted from the projects it belongs to.',
  ...
  ja: {
    ...
    'confirmMessage-deleteInformation': '期日、カスタムフィールド、説明、他のプロジェクト、タグ、コメントなど、このタスクに含まれる情報はすべて削除されます。',
    'confirmMessage-multipleTasks': '複数のタスクが選択されています。一番上のタスクのみを変換します。',
    'confirmMessage-taskIdChanged': 'タスク ID も変更されるため、このタスクを指すリンクは無効になります。',
    'confirmMessage-taskInProject': 'このタスクは、マイタスクや親タスクから削除されます。',
    'confirmMessage-taskNotInProject': 'このタスクは、所属先のプロジェクトから削除されます。',
